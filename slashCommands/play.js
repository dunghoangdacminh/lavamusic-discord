...
const { handlemsg } = require(`${process.cwd()}/handlers/functions`);
    module.exports = {
  name: `play`,
  description: `Plays a Song/Playlist from SoundCloud`,
  parameters: {
    "type": "music",
    "activeplayer": false,
    "previoussong": false
  ...
  run: async (client, interaction, cmduser, es, ls, prefix, player, message) => {
    ...
    try {
      ...
      //Send information
      interaction.reply({content: `Searching and attempting to play: **${args[0]}** from <:LogoSoundCloud:1268022370099269784> \`SoundCloud\`!`})
